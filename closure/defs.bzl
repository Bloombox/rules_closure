...
load("//closure/templates:closure_template_library.bzl", _closure_template_library = "closure_template_library")
...
closure_template_library = _closure_template_library
